...
- **1. akt - Dvorní rada**
    - Začíná rozhovorem, třech malomocných (nakažených Bílou nemocí).
    - Objevuje se např. symbolika:
        - **Bílá skrvna nebolí, je bez citu, ale zápachem odpozuje všechny okolo**
        - **Ti starší musí "vychcípat", aby zbylo místo pro další (*nepostihuje zvířata a mladého člověka*)**
        - Dvorní rada Sigelius: **Nemoc není kožního, ale čistě interního charakteru. Naprosto znecitlivělá. Doporučuje použití prostředku proti zápachu**
...
- **3. akt - Maršál**
    - Rozhovor Maršál a Ministr propagandy: Lidé touha po léku. **Staří se bojí a požadují lék. Mladí plní nadšení a fanatismu**. Maršál nařizuje touhu po léku potlačit.
    - Maršál z ničeho nic napadl sousední stát (*podobnost Československu*). Promlouvá k davu z otevřeného balkónu
        - Dav fanaticky souhlasí a oslavuje válku, Maršála
...
- Ukázky symboliky z díla:
	...
	- Otec, Baron Krüg i Maršál jsou ze začátku vůči Bílé nemoci neústupní, nakonec je ale **strach dostane na kolena**
...
- **Doktor Galén**:
    - antimilitarista; idealistický a naivní; vychytralý; neústupný; bezbranný;
    - *k prosazení svého názoru využívá lidského strachu* (on jediný dokáže léčit Bílou nemoc);
    - obránce lidství a míru (tato postava obsahuje Čapkovy autobiografické prvky – snaha o demokratičnost, odpor k násilí, atd.)
    - zastává názor, že buď lidé zemřou ve válce nebo následkem Bílé nemoci
- **Maršál**:
    - podobnost (ne náhodná) s *Adolfem Hitlerem*; vůdce a válkychtivý diktátor; cílevědomý; autoritativní; povýšený a násilnický
    - prostřednictvím války vidí možnost postavit hrdý národ; odvolává se k bohu
    - jeho jediným přítelem je *Baron Krüg*, ten od něj pod tlakem doktora Galéna žádá mír, ale Maršál neustupuje a nad jeho smrtí necítí lítost
- **Baron Krüg**:
    - majitel zbrojařských závodů; bohatý; vlivný, ale přesto působí pod taktovkou Maršála
- **Dvorní rada Sigelius**:
    - panovačný; povýšenecký; zpočátku si přivlastňuje úspěchy doktora Galéna
    - plně oddaný Maršálovi
- **Otec**
    - představitel skupiny, kterou nemoc napadá nejvíce
    - oslavuje Maršála a nemoc, jelikož díky ní získal místo ředitele účtárny v závodech Barona Krüga
    - po smrti jeho ženy si teprve uvědomí druhou stránku nemoci
- **Matka**
    - opakem otce ve vztahu k Bílé nemoci
    - hodná, starostlivá; nabízí, že se postará o babičkou nakaženou malomocenstvím
    - časem zjistí nakažení Bílou nemocí
- **Syn a dcera**
    - představitelé mladé generace, která se nechá lépe zfanatizovat
    - obdivují Maršála, Bílou nemoc a oslavují vymírání starších generací
